...
- **1 293 / 1 293 tests, 31 fichiers, en local et en configuration CI.** Les tests historiques sont conservés/adaptés. Les nouveaux cas contrôlent les dix introductions, les 120 séances, plus de 24 intentions distinctes, les infobulles, la progression, les cinq badges secrets, les notifications en file, le logo et la Partie libre épurée. Aucun test désactivé.
...
- **Audit des dépendances : zéro vulnérabilité connue**, 219 dépendances au total (11 d’exécution, 208 de développement). Aucun ajout de dépendance ni changement du lockfile. Détection de secrets sans résultat positif dans 238 fichiers, neuf commits accessibles et 337 blobs historiques.
...
Prévisualisation de production sous Chromium : accueil en clair/sombre à **320 × 568, 375 × 812, 390 × 844, 430 × 932, 820 × 1180 et 1440 × 1000**. Aucun débordement horizontal ou texte coupé sur les cartes contrôlées ; à 320 px, les deux cartes finissent à 562,75 px et restent dans le premier écran. Les flèches déclenchent la même navigation que les cartes. Le desktop conserve sa composition.
